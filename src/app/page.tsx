                ...
                <Portal>
                  <HoverCard.Positioner>
                    <HoverCard.Content maxWidth="240px">
                      <HoverCard.Arrow />
                      <Box>
                        <Strong>Taratari</Strong> is card game where we compete to finish our cards on hand. But you <Strong>WILL</Strong> be punished if you spam the cards(you're using the wrong card)
                      </Box>
                      <Box> </Box>
                      <Box>
